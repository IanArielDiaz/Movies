...
const ScienceFiccion = ({ searchTerm, onMoviesFound }) => {
  const { dataMovies, showMiniDiv, handleMouseEnter, handleMouseLeave } =
  ...
  return (
    <div className="movies-all">
      {filteredMovies.length > 0 && <h1>Science Fiction Series</h1>}
